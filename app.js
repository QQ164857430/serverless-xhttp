...
// 环境变量
const UUID = process.env.UUID || '34baa389-c65a-45e8-a050-141cd04bced3'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'serverless-xhttp.on.shiper.app';                   // 域名或ip,留空将自动获取服务器ip
